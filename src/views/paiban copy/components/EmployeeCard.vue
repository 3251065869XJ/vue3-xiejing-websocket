<template>
  <div
    class="employee-card"
    :class="{ selected: isSelected, assigned: isAssigned, disabled: employee.status === 'out_support' }"
    draggable="true"
    @click="$emit('click')"
    ...
    <div class="card-top">
      ...
      <div class="emp-info">
        ...
        <div class="emp-meta">
          ...
          <el-tag v-if="employee.status === 'external_support'" size="small" type="warning">外援</el-tag>
        </div>
      </div>
    </div>
